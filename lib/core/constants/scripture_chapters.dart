...
const Map<String, List<ChapterMeta>> _chapters = {
  ...
  'vishnu_purana': [
    ChapterMeta(
      ...
      devaTitle: 'प्रथम अंश',
      enTitle: 'Creation',
      subtitle: 'Parāśara teaches Maitreya. From Vishnu the universe arises and into Vishnu it dissolves.',
      chapterCount: 22,
      verseCount: 1500,
    ),
    ChapterMeta(
      ...
      enTitle: 'Cosmology',
      subtitle: 'Seven continents and seven seas. Bhāratavarṣa — the land of action where karma bears fruit.',
      chapterCount: 16,
      verseCount: 1100,
    ),
    ChapterMeta(
      ...
      subtitle: 'Vyāsa divides the Vedas fourfold. Vishnu alone is all the world and the supreme state.',
      chapterCount: 18,
      verseCount: 700,
    ),
    ChapterMeta(
      ...
      subtitle: 'The Solar dynasty from Manu through Ikṣvāku to Raghu, Aja, Daśaratha, and Rāmacandra.',
      chapterCount: 24,
      verseCount: 700,
    ),
    ChapterMeta(
      ...
      subtitle: 'Birth in Mathurā, childhood in Gokula, slaying of Kaṃsa, and the Bhagavad Gītā at Kurukṣetra.',
      chapterCount: 38,
      verseCount: 1500,
    ),
    ChapterMeta(
      ...
      devaTitle: 'षष्ठ अंश',
      enTitle: 'Liberation',
      subtitle: 'Signs of Kali Yuga. Hari\'s name alone is the way. All the world is pervaded by Vishnu.',
      chapterCount: 8,
      verseCount: 500,
    ),
  ],
  'devi_bhagavata_purana': [
    ...
    ChapterMeta(
      ...
      subtitle: 'The Devī slays Mahiṣāsura. The gods praise her as consciousness in all beings.',
      chapterCount: 35,
      verseCount: 3500,
    ),
    ChapterMeta(
    ...
    ChapterMeta(
      ...
      devaTitle: 'सप्तम स्कन्ध',
      enTitle: 'Devī Gītā',
      subtitle: '"I alone am Brahman." The Devī teaches the supreme knowledge of her own nature.',
      chapterCount: 40,
      verseCount: 2200,
    ),
    ChapterMeta(
    ...
    ChapterMeta(
      ...
      subtitle: 'Daily recitation grants liberation. All the world is full of Śakti.',
      chapterCount: 14,
      verseCount: 1230,
    ),
  ],
  'rigveda': [
    ChapterMeta(
      ...
      subtitle: 'Various seers — Madhuchchandas, Medhātithi, Śunaḥśepa. Hymns to Agni, Indra, the Aśvins.',
      chapterCount: 191,
      verseCount: 2006,
    ),
    ChapterMeta(
    ...
    ChapterMeta(
      ...
      subtitle: 'The Nāsadīya Sūkta on creation, the Puruṣa Sūkta, the Hiraṇyagarbha Sūkta.',
      chapterCount: 191,
      verseCount: 1754,
    ),
  ],
  'atharvaveda': [
    ChapterMeta(chapterNum: 1, devaTitle: 'प्रथम काण्ड', enTitle: 'Healing and Long Life', chapterCount: 35),
    ChapterMeta(chapterNum: 2, devaTitle: 'द्वितीय काण्ड', enTitle: 'Charms Against Disease', chapterCount: 36),
    ChapterMeta(chapterNum: 3, devaTitle: 'तृतीय काण्ड', enTitle: 'Prosperity and Protection', chapterCount: 31),
    ChapterMeta(chapterNum: 4, devaTitle: 'चतुर्थ काण्ड', enTitle: 'Charms for Power and Glory', chapterCount: 40),
    ChapterMeta(chapterNum: 5, devaTitle: 'पञ्चम काण्ड', enTitle: 'Hymns for Various Ends', chapterCount: 31),
    ChapterMeta(chapterNum: 6, devaTitle: 'षष्ठ काण्ड', enTitle: 'Short Charms', chapterCount: 142),
    ChapterMeta(chapterNum: 7, devaTitle: 'सप्तम काण्ड', enTitle: 'Miscellaneous Hymns', chapterCount: 123),
    ChapterMeta(chapterNum: 8, devaTitle: 'अष्टम काण्ड', enTitle: 'Long Speculative Hymns', chapterCount: 10),
    ChapterMeta(chapterNum: 9, devaTitle: 'नवम काण्ड', enTitle: 'Ritual and Mystical Hymns', chapterCount: 10),
    ChapterMeta(chapterNum: 10, devaTitle: 'दशम काण्ड', enTitle: 'Cosmogonic Hymns', chapterCount: 10),
    ChapterMeta(chapterNum: 11, devaTitle: 'एकादश काण्ड', enTitle: 'Brahmaudana and Vrātya', chapterCount: 10),
    ChapterMeta(chapterNum: 12, devaTitle: 'द्वादश काण्ड', enTitle: 'Pṛthivī Sūkta — Hymn to Earth', chapterCount: 5),
    ChapterMeta(chapterNum: 13, devaTitle: 'त्रयोदश काण्ड', enTitle: 'Rohita — The Sun God', chapterCount: 4),
    ChapterMeta(chapterNum: 14, devaTitle: 'चतुर्दश काण्ड', enTitle: 'Marriage Hymns', chapterCount: 2),
    ChapterMeta(chapterNum: 15, devaTitle: 'पञ्चदश काण्ड', enTitle: 'The Vrātya Books', chapterCount: 18),
    ChapterMeta(chapterNum: 16, devaTitle: 'षोडश काण्ड', enTitle: 'Imprecations and Spells', chapterCount: 9),
    ChapterMeta(chapterNum: 17, devaTitle: 'सप्तदश काण्ड', enTitle: 'A Single Long Hymn', chapterCount: 1),
    ChapterMeta(chapterNum: 18, devaTitle: 'अष्टादश काण्ड', enTitle: 'Funeral Hymns', chapterCount: 4),
    ChapterMeta(chapterNum: 19, devaTitle: 'एकोनविंशति काण्ड', enTitle: 'Supplementary Hymns', chapterCount: 72),
    ChapterMeta(chapterNum: 20, devaTitle: 'विंशति काण्ड', enTitle: 'Sāmavedic Borrowings', chapterCount: 143),
  ],
  'mahabharata': [
    ChapterMeta(chapterNum: 1, devaTitle: 'आदिपर्व', enTitle: 'Ādi Parva — The Beginning', subtitle: 'Origins of the Kuru lineage. The births of Bhīṣma, Pāṇḍu, Dhṛtarāṣṭra, and the Pāṇḍavas.', chapterCount: 236, verseCount: 7898),
    ChapterMeta(chapterNum: 2, devaTitle: 'सभापर्व', enTitle: 'Sabhā Parva — The Hall', chapterCount: 81, verseCount: 2701),
    ChapterMeta(chapterNum: 3, devaTitle: 'वनपर्व', enTitle: 'Vana Parva — The Forest', chapterCount: 313, verseCount: 11664),
    ChapterMeta(chapterNum: 4, devaTitle: 'विराटपर्व', enTitle: 'Virāṭa Parva — The Year of Disguise', chapterCount: 67, verseCount: 2050),
    ChapterMeta(chapterNum: 5, devaTitle: 'उद्योगपर्व', enTitle: 'Udyoga Parva — Preparation for War', chapterCount: 199, verseCount: 6998),
    ChapterMeta(chapterNum: 6, devaTitle: 'भीष्मपर्व', enTitle: 'Bhīṣma Parva — The Fall of Bhīṣma', subtitle: 'Contains the Bhagavad Gītā (chapters 23–40).', chapterCount: 117, verseCount: 5884),
    ChapterMeta(chapterNum: 7, devaTitle: 'द्रोणपर्व', enTitle: 'Droṇa Parva — The Death of Droṇa', chapterCount: 173, verseCount: 8909),
    ChapterMeta(chapterNum: 8, devaTitle: 'कर्णपर्व', enTitle: 'Karṇa Parva — The Death of Karṇa', chapterCount: 69, verseCount: 4964),
    ChapterMeta(chapterNum: 9, devaTitle: 'शल्यपर्व', enTitle: 'Śalya Parva — The Death of Śalya', chapterCount: 64, verseCount: 3220),
    ChapterMeta(chapterNum: 10, devaTitle: 'सौप्तिकपर्व', enTitle: 'Sauptika Parva — The Night Massacre', chapterCount: 18, verseCount: 870),
    ChapterMeta(chapterNum: 11, devaTitle: 'स्त्रीपर्व', enTitle: 'Strī Parva — Lamentation of the Women', chapterCount: 27, verseCount: 775),
    ChapterMeta(chapterNum: 12, devaTitle: 'शान्तिपर्व', enTitle: 'Śānti Parva — Counsel of Peace', subtitle: 'Bhīṣma teaches dharma, mokṣa, and rājanīti from his bed of arrows.', chapterCount: 365, verseCount: 14732),
    ChapterMeta(chapterNum: 13, devaTitle: 'अनुशासनपर्व', enTitle: 'Anuśāsana Parva — Final Teachings', chapterCount: 168, verseCount: 8000),
    ChapterMeta(chapterNum: 14, devaTitle: 'अश्वमेधिकपर्व', enTitle: 'Aśvamedhika Parva — The Horse Sacrifice', chapterCount: 96, verseCount: 2743),
    ChapterMeta(chapterNum: 15, devaTitle: 'आश्रमवासिकपर्व', enTitle: 'Āśramavāsika Parva — Retirement to the Forest', chapterCount: 47, verseCount: 1062),
    ChapterMeta(chapterNum: 16, devaTitle: 'मौसलपर्व', enTitle: 'Mausala Parva — The End of the Yādavas', chapterCount: 9, verseCount: 273),
    ChapterMeta(chapterNum: 17, devaTitle: 'महाप्रस्थानिकपर्व', enTitle: 'Mahāprasthānika Parva — The Great Journey', chapterCount: 3, verseCount: 106),
    ChapterMeta(chapterNum: 18, devaTitle: 'स्वर्गारोहणपर्व', enTitle: 'Svargārohaṇa Parva — Ascent to Heaven', chapterCount: 5, verseCount: 200),
  ],
  'ramayana': [
    ChapterMeta(chapterNum: 1, devaTitle: 'बालकाण्ड', enTitle: 'Bāla Kāṇḍa — Childhood', subtitle: 'Birth of Rāma. The breaking of Śiva\'s bow and the marriage to Sītā.', chapterCount: 77, verseCount: 2272),
    ChapterMeta(chapterNum: 2, devaTitle: 'अयोध्याकाण्ड', enTitle: 'Ayodhyā Kāṇḍa — The Exile', chapterCount: 119, verseCount: 3800),
    ChapterMeta(chapterNum: 3, devaTitle: 'अरण्यकाण्ड', enTitle: 'Araṇya Kāṇḍa — The Forest', subtitle: 'Sītā\'s abduction by Rāvaṇa. The death of Jaṭāyu.', chapterCount: 75, verseCount: 2440),
    ChapterMeta(chapterNum: 4, devaTitle: 'किष्किन्धाकाण्ड', enTitle: 'Kiṣkindhā Kāṇḍa — Alliance with Sugrīva', chapterCount: 67, verseCount: 2200),
    ChapterMeta(chapterNum: 5, devaTitle: 'सुन्दरकाण्ड', enTitle: 'Sundara Kāṇḍa — Hanumān\'s Leap', subtitle: 'Hanumān crosses the ocean to Laṅkā and finds Sītā in the Aśoka grove.', chapterCount: 68, verseCount: 2879),
    ChapterMeta(chapterNum: 6, devaTitle: 'युद्धकाण्ड', enTitle: 'Yuddha Kāṇḍa — The Great Battle', subtitle: 'The bridge to Laṅkā, the war with Rāvaṇa, and the return of Rāma.', chapterCount: 128, verseCount: 3170),
    ChapterMeta(chapterNum: 7, devaTitle: 'उत्तरकाण्ड', enTitle: 'Uttara Kāṇḍa — The Final Chapters', chapterCount: 100, verseCount: 2000),
  ],
  'markandeya_purana': [
