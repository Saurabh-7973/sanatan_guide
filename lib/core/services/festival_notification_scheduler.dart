...
abstract final class FestivalNotificationScheduler {
  ...
  static Future<void> sync({
    ...
    await prefs.setString(PrefsKeys.festivalNotifIds, jsonEncode(scheduledIds));
  ...
  static Future<void> _cancelPrior(SharedPreferences prefs) async {
    final raw = prefs.getString(PrefsKeys.festivalNotifIds);
    ...
    await prefs.remove(PrefsKeys.festivalNotifIds);
  }
