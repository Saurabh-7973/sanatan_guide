...
class PathCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final total = modulesAsync.value?.length ?? 0;
    final completed = modulesAsync.value
    ...
    Scripture? scripture;
    if (lastRead != null) {
      scripture = Scripture.values.cast<Scripture?>().firstWhere(
            (s) => s?.code == lastRead.scriptureCode,
            orElse: () => null,
          );
    }
