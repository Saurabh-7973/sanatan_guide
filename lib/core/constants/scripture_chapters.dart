...
const Map<String, List<ChapterMeta>> _chapters = {
  ...
  // Counts are the bundled DB's per-parva actuals (book_num populated from the
  // verse id). The bundle does not contain Sauptika Parva (canonical parva 10),
  // so it is omitted rather than shown as an empty book — the remaining 17
  // parvas keep their canonical numbers so taps map to the right book_num.
  'mahabharata': [
    ChapterMeta(
        chapterNum: 1,
        devaTitle: 'आदिपर्व',
