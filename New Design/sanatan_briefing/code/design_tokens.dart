...
class DColors {
  ...
  static const ironRed = Color(0xFFB85A3A); // for borders / icons / non-text
  static const ironRedBright = Color(0xFFD17048); // for text (better contrast)
...
class LColors {
  ...
  static const cream = Color(0xFF2A1E14); // dark cream = primary text
  ...
  // Dividers
  static const divider = Color(0x40C26508); // 25% saffron
  ...
  // Locked thread
  static const threadLocked = Color(0x408B4806); // 25% saffron-deep
}
...
class Spacing {
  ...
  // Common pattern: screen-edge horizontal padding
  static const screenH = 24.0;

  // Common pattern: vertical rhythm between sections
...
// ============================================================
class Radii {
  static const card = 4.0;          // verse cards, leaves
  static const pill = 18.0;         // chips, segmented controls
  static const pillSm = 11.0;       // small lock pills
  static const sheet = 12.0;        // bottom sheet top corners
  static const button = 28.0;       // primary CTA
...
class Motion {
  ...
  static const elastic = Curves.easeOutBack; // for the saffron-thread "extends" animation
}
...
// ============================================================
class Glows {
  // Saffron leaf-thread on dark
  static List<BoxShadow> threadDark = [
    BoxShadow(
      color: const Color(0x80E8820C), // 50% saffron
      blurRadius: 6,
      spreadRadius: 0,
    ),
  ];

  // Active module knot (Practice screen)
  static List<BoxShadow> activeKnotDark = [
    BoxShadow(
      color: const Color(0x8CE8820C), // 55% saffron
      blurRadius: 8,
    ),
  ];

  // Cream shadow for Pūrṇimā moon (Festivals)
  static List<BoxShadow> moonGlowDark = [
    BoxShadow(
      color: const Color(0x33F2E5CE), // 20% cream
      blurRadius: 4,
    ),
  ];
}
