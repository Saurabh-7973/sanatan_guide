...
abstract final class AppTypography {
  ...
  // ── Emoji / symbol-only (no Latin font — system emoji fallback) ─────────

  /// Festival banner leading emoji.
  static const TextStyle emojiBanner = TextStyle(fontSize: 22, height: 1);

  /// Inline emoji next to body text (e.g. streak lamp).
  static const TextStyle emojiInline = TextStyle(fontSize: 15, height: 1);
}
